...
<body class="sidebar-mini wysihtml5-supported skin-red-light " ng-app="authorization" >
	...
	<style>
		...
		<div class="content-wrapper" ng-controller="authoriCon" id="authorizationApp">
						...
						<div class="col-sm-12">
							<div class="tablecontainer table-responsive" data-ng-init="listAuthorization()">
								<table class="table table-hover">
									<thead>
										<tr>
											<th class="wdiths-30"  ng-click="sort('authId')">Authorization ID
											...
											<th class="wdiths-30" ng-click="sort('authName')">Authorization Name
											...
											<th class="wdiths-30"  ng-click="sort('authType')">Authorization Type
									...
									<tbody>
										<tbody>
											...
											<tr pagination-id="listauth" dir-paginate="data in auth |orderBy:sortKey:reverse |filter:search |itemsPerPage:10"  >
												...
												<td ng-cloak >
													<button class="btn btn-default btn-sm"  data-toggle="modal" data-target="#myModal" ng-click="getauthByID(data.authId)"  data-toggle="modal" data-target="#myModalEdit"><i class="glyphicon glyphicon-pencil"></i> </button>
													<button class="btn btn-default btn-sm" ng-click="deleteAuthorizationId(data.authId,data.authName)"><i class="glyphicon glyphicon-trash"></i> </button>
												</td>							
											</tr> 
			...
			<div   data-backdrop="static" class="modal fade bs-example-modal-lg" id="myModal"  role="dialog" aria-labelledby="myModalLabel">
	...
	<script type="text/javascript">
			...
			app.controller('authoriCon',['$scope','$http',function($scope, $http){	
				...
				$scope.deleteAuthorizationId = function(authID,authName){
					swal({
						title:  "<span style='font-size: 20px;'>Are you sure you want to delete this  authorization with ID "+authID+"</span>",
						text: "Click OK to continue or CANCEL to abort.",
						type: "info",
						html: true,
						showCancelButton: true,
