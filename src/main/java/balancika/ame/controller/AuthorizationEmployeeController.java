...
public class AuthorizationEmployeeController {
	...
	public ResponseEntity<Map<String, Object>> getAuthorizationEmployee(@PathVariable("AuthD") String empId) throws SQLException{
	...
	public ResponseEntity<Map<String, Object>> getAuthorizationEmployee(@PathVariable("empId") String empId,@PathVariable("process") String process,@PathVariable("authId") String authId) throws SQLException{
		Map<String, Object> map = new HashMap<String, Object>();
		try {
	...
	public ResponseEntity<Map<String, Object>> createAuthorizationEmployee(@RequestBody AuthorizationEmployee authEmp) throws SQLException{
		Map<String, Object> map = new HashMap<String, Object>();
		try {
			Map<String, Object> auth = new HashMap<String, Object>();
			auth = authService.createAuthorizationEmployee(dataSource, authEmp);
